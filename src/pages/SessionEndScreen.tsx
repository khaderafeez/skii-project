      ...
      <div className="min-h-screen w-full ecg-grid-bg text-white flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-sm flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-xl font-bold text-medical-cyan font-mono tracking-wider">
              HRV ADAPTIVE RHYTHM
            </h1>
            <p className="text-xs text-gray-500 mt-1">
              Session Complete — How do you feel?
            </p>
          </div>
          ...
          <div
            ...
            style={{
              filter: `drop-shadow(0 0 20px ${mood.color}60)`
            }}>
    ...
    <div className="min-h-screen w-full ecg-grid-bg text-white flex flex-col print:bg-white print:text-gray-900">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-medical-grid print:border-gray-300">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-medical-cyan font-mono tracking-wider print:text-gray-900">
              SESSION COMPLETE
            </h1>
            <p className="text-xs text-gray-500">
              HRV Adaptive Rhythm — Report
            </p>
          </div>
        </div>
      ...
      <main className="flex-1 px-4 py-4 flex flex-col gap-4 max-w-2xl mx-auto w-full overflow-y-auto">
        ...
        <div className="flex items-center gap-3 bg-medical-green/10 border border-medical-green/30 rounded-lg px-4 py-3 print:bg-green-50">
          ...
          <div className="flex-1">
            <p className="font-mono font-bold text-medical-green text-sm">
          ...
          <div className="text-right">
            ...
            <p
              ...
              style={{
                color: getEmoji(sliderValue).color
              }}>
        ...
        <div className="bg-medical-bg-secondary border border-medical-grid rounded-lg p-4 print:bg-gray-50">
          <h2 className="text-xs font-mono font-semibold text-gray-500 uppercase tracking-widest mb-3">
            Session Info
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
            ...
            <div>
              <p className="text-gray-500 text-xs mb-0.5">Music</p>
              <p className="font-mono font-semibold text-purple-300 print:text-purple-700">
                Calming
              </p>
            </div>
            <div>
              <p className="text-gray-500 text-xs mb-0.5">Phase</p>
              <p className="font-mono font-semibold text-medical-cyan">
                Phase 2
              </p>
            </div>
            <div>
        ...
        {/* Action Buttons: Finish / Restart / Print */}
        <section aria-label="Actions" className="mt-auto pt-2 print:hidden">
          <div className="grid grid-cols-3 gap-2">
            <button
              onClick={onNewSession}
              className="py-3 rounded-lg border border-medical-grid bg-medical-bg-secondary hover:bg-medical-grid text-gray-300 font-mono font-bold text-sm transition-colors flex items-center justify-center gap-1.5">
            ...
            <button
              onClick={onRestart}
              className="py-3 rounded-lg border border-medical-cyan/40 bg-medical-cyan/5 hover:bg-medical-cyan/10 text-medical-cyan font-mono font-bold text-sm transition-colors flex items-center justify-center gap-1.5">
            ...
            <button
              onClick={handlePrint}
              className="py-3 rounded-lg bg-medical-cyan text-medical-bg font-mono font-bold text-sm hover:bg-medical-cyan/90 transition-colors flex items-center justify-center gap-1.5">
        ...
        <div className="hidden print:block mt-8 pt-4 border-t border-gray-300 text-xs text-gray-500 text-center">
          <p>
            HRV Adaptive Rhythm — Session Report · Generated{' '}
            {new Date().toLocaleString()}
          </p>
          <p className="mt-1">
            Wellbeing Score: {sliderValue}/100 {getEmoji(sliderValue).emoji}
          </p>
        </div>
      </main>
    </div>);
